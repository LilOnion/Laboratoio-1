/*
*El programa listará y enumerará tres candidatos para presidente,
*entonces deja emitir votos hasta presionar la tecla F
*entregará los resultados felicitando a quien ganó.
*mostrar total de votos efectuados,
*el número de votos obtenidos por cada candidato
*incluya votos nulos
*todo con su porcentaje.
*/
