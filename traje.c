/*
*todos los trajes que tienen un precio superior a $2500.00 se les aplicará un descuento de 15 %
*a todos los demás se les aplicará sólo 8 %
*algoritmo para determinar el precio final
*cuánto es el descuento que obtendrá
*/
#include <stdio.h>
#include <stdlib.h>
